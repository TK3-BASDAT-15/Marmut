...
urlpatterns = [
    ...
    path('play-song/<str:id>/', user_play_song, name = 'user_play_song'),
    path('delete-song/<str:id_song>/<str:id_playlist>/<str:id_user_playlist>/', user_delete_song, name = 'user_delete_song'),
    path('add-song/<str:id_playlist>/<str:id_user_playlist>/', user_add_song, name = 'user_add_song'),
    path('play-playlist/', play_user_playlist, name = 'play_user_Playlist'),
    path('detail-song/<str:id>/<str:id_playlist>/', user_song_detail, name = 'user_song_detail'),
    path('download/<str:id_song>/', user_download, name = 'user_download'),
    path('to-playlist/<str:id_song>/', add_song_spesific_playlist, name = 'add_song_spesific_playlist'),
